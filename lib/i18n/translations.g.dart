 ...
 *
 * Built on 2023-06-30 at 14:10 UTC
 */
...
class _TranslationsSendEn {
  ...
  late final _TranslationsSendSendResultEn sendResult =
      _TranslationsSendSendResultEn._(_root);
}
...
class _TranslationsSendSendResultEn {
  ...
  String get connectionFail =>
      'send failed. please check the devices are in same network.';
...
class _TranslationsJa implements _TranslationsEn {
  ...
  // Translations
  @override
  late final _TranslationsActionsJa actions = _TranslationsActionsJa._(_root);
  @override
  late final _TranslationsSendJa send = _TranslationsSendJa._(_root);
  @override
  late final _TranslationsParamsJa params = _TranslationsParamsJa._(_root);
}
...
class _TranslationsSendJa implements _TranslationsSendEn {
  ...
  // Translations
  @override
  String get receiverAddress => '受信者のIPアドレス';
  @override
  String get selectFile => 'ファイルを選択';
  @override
  String get fileNone => 'ファイル無し';
  @override
  String get sendibleAddress => '送信可能アドレス';
  @override
  late final _TranslationsSendSendResultJa sendResult =
      _TranslationsSendSendResultJa._(_root);
}
...
class _TranslationsSendSendResultJa implements _TranslationsSendSendResultEn {
  ...
  // Translations
  @override
  String get success => '送信完了しました';
  @override
  String get connectionFail => '送信失敗しました。同じネットワーク内にいることを確認してください。';
  @override
  String get lostFile => 'ファイルがありません。';
  @override
  String get sendFail => '接続先のデバイスに送信できません。';
}
...
extension on _TranslationsEn {
  Map<String, dynamic> _buildFlatMap() {
    return <String, dynamic>{
      ...
      'send.sendResult.connectionFail':
          'send failed. please check the devices are in same network.',
      'send.sendResult.lostFile': 'did not find the file.',
      'send.sendResult.sendFail':
          'did not send the file to the connected device.',
