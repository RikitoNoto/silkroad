...
import 'package:silkroad/send/entities/sendible_device.dart' as _i6;
...
class MockSendRepository extends _i1.Mock implements _i5.SendRepository {
  ...
  _i4.Stream<_i6.SendibleDevice> seachDevices(
    ...
    int? sendPort,
    String? bindPoint, {
    dynamic timeout = const Duration(seconds: 3),
...
class MockSocket extends _i1.Mock implements _i2.Socket {
  ...
  @override
  _i4.Future<void> forEach(void Function(_i7.Uint8List)? action) =>
      (super.noSuchMethod(
        Invocation.method(
          #forEach,
          [action],
